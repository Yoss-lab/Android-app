...
import hatem.ali.leoni.helpers.JSONParser;
...
public class AllUsersActivity extends ListActivity {
    ...
    private static String url_all_products = "http:// 192.168.1.15/leoni/get_all_users.php";
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            ...
                            TAG_NAME,TAG_EMAIL,TAG_PASSWORD},
                            new int[] { R.id.id, R.id.pseudo ,R.id.email,R.id.password});
                    // updating listview
