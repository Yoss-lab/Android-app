...
import hatem.ali.leoni.fragments.ActualiteFragment;
import hatem.ali.leoni.fragments.EmploiFragment;
import hatem.ali.leoni.fragments.MenuFragment;
import hatem.ali.leoni.fragments.StageFragment;


public class EspacemembreActivity extends AppCompatActivity {
    TextView id,name,mail,phone;
    private ActionBar toolbar;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_espacemembre);
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.navigationAct:
                    toolbar.setTitle("Actualité");
                    fragment=new ActualiteFragment();
    ...
    private void loadFragment(Fragment fragment) {
        ...
        transaction.replace(R.id.frame_espaceMembre, fragment);
