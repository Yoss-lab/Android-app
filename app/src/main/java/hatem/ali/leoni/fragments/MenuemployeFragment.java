 ...
 */
public class MenuemployeFragment extends Fragment {
    ...
    public MenuemployeFragment() {
        // Required empty public constructor
    }

    public static MenuemployeFragment newInstance(String param1) {
        MenuemployeFragment fragment = new MenuemployeFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       /* String mail=this.getArguments().getString("mailkey");
        ...
        View v= inflater.inflate(R.layout.fragment_menuemploye, container, false);
